...
wWastedByteCD39:: db ;this is used for experience now
...
wFieldMoves:: ds NUM_MOVES + 1
wNumFieldMoves:: db
wFieldMovesLeftmostXCoord:: db
wLastFieldMoveID:: db ; used to check for HM in HasHM
...
wSwitchedMonType1:: db
wSwitchedMonType2:: db
...
wAISwitchingTracker:: db ;used for switching
...
wViridianWildsCurScript:: db
wMtMoonSummitCurScript:: db
wTowerGroundsCurScript:: db
