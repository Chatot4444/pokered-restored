...
; entries correspond to constants/pokemon_constants.asm
	...
	mon_cry CRY_KRABBY,        40,  180 ; MIME JR	
	mon_cry CRY_PIDGEOTTO,    40,  220 ; HAPPINEY
	mon_cry CRY_GRIMER,       100,  120 ; MUNCHLAX	
	mon_cry CRY_METAPOD,      -60,  320 ; MAGNEZONE
	mon_cry CRY_SEEL,          -60,  286 ; LICKILICKY
	mon_cry CRY_RHYDON,        -30,  356 ; RHYPERIOR
	mon_cry CRY_GOLEM,         -30,  256 ; TANGROWTH
	mon_cry CRY_VOLTORB,     80,  283 ; ELECTIVIRE
	mon_cry CRY_CHARMANDER,  160,  160 ; MAGMORTAR
	mon_cry CRY_WOOPER,      0,  575 ; LEAFEON
	mon_cry CRY_HOOTHOOT,    490,  432 ; GLACEON
	mon_cry CRY_GIRAFARIG,   90,  580 ; PORYGONZ
	mon_cry CRY_CLEFFA,     97,  656 ; SYLVEON
	mon_cry CRY_RATTATA,       0,  256 ; RATTATAA
	mon_cry CRY_RATTATA,      32,  383 ; RATICATEA
	mon_cry CRY_RAICHU,      238,  136 ; RAICHUA
	mon_cry CRY_NIDORAN_M,    32,  192 ; SANDSHREWA
	mon_cry CRY_NIDORAN_M,   255,  383 ; SANDSLASHA
	mon_cry CRY_VULPIX,       79,  144 ; VULPIXA
	mon_cry CRY_VULPIX,      136,  224 ; NINETALESA
	mon_cry CRY_DIGLETT,     170,  129 ; DIGLETTA
	mon_cry CRY_DIGLETT,      42,  144 ; DUGTRIOA
	mon_cry CRY_CLEFAIRY,    119,  144 ; MEOWTHA
	mon_cry CRY_CLEFAIRY,    153,  383 ; PERSIANA
	mon_cry CRY_VULPIX,      240,  144 ; GEODUDEA
	mon_cry CRY_VULPIX,        0,  256 ; GRAVELERA
	mon_cry CRY_GOLEM,       224,  192 ; GOLEMA
	mon_cry CRY_GRIMER,        0,  256 ; GRIMERA
	mon_cry CRY_MUK,         239,  383 ; MUKA
	mon_cry CRY_DROWZEE,       0,  256 ; EXEGGUTORA	
	mon_cry CRY_ODDISH,       79,  224 ; MAROWAKA	
	mon_cry CRY_CLEFAIRY,    119,  144 ; MEOWTHG
	mon_cry CRY_CLEFAIRY,    153,  383 ; PERRSERKER
	mon_cry CRY_WEEPINBELL,    0,  256 ; PONYTAG
	mon_cry CRY_WEEPINBELL,   32,  320 ; RAPIDASHG
	mon_cry CRY_SLOWPOKE,      0,  256 ; SLOWPOKEG
	mon_cry CRY_GROWLITHE,     0,  256 ; SLOWBROG
	mon_cry CRY_SLOWKING,    260,  512 ; SLOWKINGG
	mon_cry CRY_SPEAROW,     221,  129 ; FARFETCH_DG
	mon_cry CRY_SPEAROW,     121,  100 ; SIRFETCH_D
	mon_cry CRY_GOLEM,       255,  383 ; WEEZINGG
	mon_cry CRY_KRABBY,        8,  192 ; MR__MIMEG
	mon_cry CRY_KRABBY,        8,  192 ; MR__RIME
	mon_cry CRY_RAICHU,      128,  192 ; ARTICUNOG
	mon_cry CRY_FEAROW,      255,  256 ; ZAPDOSG
	mon_cry CRY_RAICHU,      248,  192 ; MOLTRESG
