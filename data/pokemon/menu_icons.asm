MonPartyData:
	...
	nybble ICON_QUADRUPED  ; Rattataa  
	nybble ICON_QUADRUPED ;  Raticatea
	nybble ICON_FAIRY 	 ; Raichua   
	nybble ICON_MON ; Sandshrewa
	nybble ICON_MON  	 ; Sandslasha  
	nybble ICON_QUADRUPED ;  Vulpixa
	nybble ICON_QUADRUPED  	 ; Ninetalesa  
	nybble ICON_MON ;  Digletta
	nybble ICON_MON   ; Dugtrioa  
	nybble ICON_MON ;  Meowtha
	nybble ICON_MON   ; Persiana  
	nybble ICON_MON ;  Geodudea 
	nybble ICON_MON    ; Gravelera  
	nybble ICON_MON       ;  Golema
	nybble ICON_MON  ; Grimera 
	nybble ICON_MON ;   Muka 
	nybble ICON_GRASS  ; Exeggutora  
	nybble ICON_MON ;  Marowaka
	nybble ICON_MON       ; Meowthg
	nybble ICON_MON       ; Perrserker
	nybble ICON_QUADRUPED ; Ponytag
	nybble ICON_QUADRUPED ; Rapidashg
	nybble ICON_QUADRUPED ; Slowpokeg
	nybble ICON_MON       ; Slowbrog
	nybble ICON_MON       ; Slowkingg
	nybble ICON_BIRD      ; Farfetch'dg
	nybble ICON_BIRD      ; Sirfetch'd
	nybble ICON_MON       ; Weezingg
	nybble ICON_MON       ; Mr.Mimeg
	nybble ICON_MON       ; Mr.Rime
	nybble ICON_BIRD      ; Articunog
	nybble ICON_BIRD      ; Zapdosg
	nybble ICON_BIRD      ; Moltresg
