MtMoon1F_Object:
	...
	warp_event 37, 3, MT_MOON_SUMMIT, 1
	...
	object_event 5, 32, SPRITE_POKE_BALL, STAY, NONE, 13, REPEL
	object_event 35, 4, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, 14 ;person
