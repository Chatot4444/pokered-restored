ViridianForest_Object:
	...
	warp_event 0, 29, VIRIDIAN_WILDS, 1
	...
	object_event 12, 29, SPRITE_POKE_BALL, STAY, NONE, 6, TM_WATER_GUN
	object_event 1, 31, SPRITE_POKE_BALL, STAY, NONE, 7, POKE_BALL
	object_event 27, 40, SPRITE_YOUNGSTER, STAY, NONE, 8 ; person
	object_event 1, 29, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, 9 ; person
