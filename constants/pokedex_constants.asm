...
; - MonsterPalettes (see data/pokemon/palettes.asm)
	...
	const DEX_PICHU		 ; 153
	const DEX_CLEFFA	 ; 154
	const DEX_IGGLYBUFF	 ; 155
	const DEX_BELLOSSOM  ; 156
	const DEX_POLITOED   ; 157
	const DEX_ESPEON     ; 158
	const DEX_UMBREON    ; 159
	const DEX_SLOWKING   ; 160
	const DEX_STEELIX    ; 161
	const DEX_SCIZOR     ; 162
	const DEX_KINGDRA    ; 163
	const DEX_PORYGON2   ; 164
	const DEX_TYROGUE	 ; 165
	const DEX_HITMONTOP	 ; 166
	const DEX_SMOOCHUM	 ; 167
	const DEX_ELEKID	 ; 168
	const DEX_MAGBY	 	 ; 169
	const DEX_BLISSEY    ; 170
	const DEX_MIME_JR	 ; 171
	const DEX_HAPPINY	 ; 172
	const DEX_MUNCHLAX	 ; 173
	const DEX_MAGNEZONE  ; 174
	const DEX_LICKILICKY ; 175
	const DEX_RHYPERIOR  ; 176
	const DEX_TANGROWTH  ; 177
	const DEX_ELECTIVIRE ; 178
	const DEX_MAGMORTAR  ; 179
	const DEX_LEAFEON    ; 180
	const DEX_GLACEON    ; 181
	const DEX_PORYGONZ   ; 182
	const DEX_SYLVEON    ; 183
	const DEX_RATTATAA			 ; 184
	const DEX_RATICATEA			 ; 185
	const DEX_RAICHUA			 ; 186
	const DEX_SANDSHREWA		 ; 187
	const DEX_SANDSLASHA		 ; 188
	const DEX_VULPIXA			 ; 189
	const DEX_NINETALESA		 ; 190
	const DEX_DIGLETTA			 ; 191
	const DEX_DUGTRIOA			 ; 192
	const DEX_MEOWTHA			 ; 193
	const DEX_PERSIANA			 ; 194
	const DEX_GEODUDEA			 ; 195
	const DEX_GRAVELERA			 ; 196
	const DEX_GOLEMA			 ; 197
	const DEX_GRIMERA			 ; 198
	const DEX_MUKA				 ; 199
	const DEX_EXEGGUTORA		 ; 200
	const DEX_MAROWAKA			 ; 201
	const DEX_MEOWTHG			 ; 202
	const DEX_PERRSERKER		 ; 203
	const DEX_PONYTAG			 ; 204
	const DEX_RAPIDASHG			 ; 205
	const DEX_SLOWPOKEG			 ; 206
	const DEX_SLOWBROG			 ; 207
	const DEX_SLOWKINGG			 ; 208
	const DEX_FARFETCHDG		 ; 209
	const DEX_SIRFETCHD			 ; 210
	const DEX_WEEZINGG			 ; 211
	const DEX_MR_MIMEG			 ; 212
	const DEX_MR_RIME			 ; 213
